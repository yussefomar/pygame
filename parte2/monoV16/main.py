import pygame
import time
from personajes import Mario, Donkingkong,Fondo,Fuego,Barriles
...
while jugando:
    ...
    if mario.colisiona_con(fuego1):
       print("¡Mario chocó con fuego1! en la ",mario.obtener_lado_colision(fuego1))
    elif mario.colisiona_con(donkingkong):
       print("¡Mario chocó con donkingkon! en la ",mario.obtener_lado_colision(donkingkong))
