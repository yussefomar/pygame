...
otro_bloque=Bloque("imagenesmono/hojasprite.png",COLOR_NEGRO, 56, 552, 52, 18,1)

lista_personajes=[fondo,donkingkong,mario,fuego,fuego1,fuego2,barriles,un_bloque, otro_bloque]
