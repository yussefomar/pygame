...
class Personaje(pygame.sprite.Sprite):
    ...
    def cargar_superficies_numframe_delays(self,animaciones):
        ...
        for animacion, data in animaciones.items():
            ...
            for frame in data["frames"].values():
                ...
                clip=pygame.transform.scale(clip, (self.scale_ancho, self.scale_alto))
    ...
    def hay_colision(self, otro_personaje):
        ...
        excepciones = [self.tipo, "ventana"]
        if otro_personaje.tipo not in excepciones:
            return  self.rectangulo_colision.colliderect(otro_personaje.rectangulo_colision)
        else:
            return None

        
    def colision_bloques(self,lista_bloques):
...
class Mario(Personaje):
    ...
    def actualizar_posicion(self):
        ...
        #if  self.saltando==False and  self.velocidad_x == 0 and self.velocidad_y == 0:
    ...
    def aumevelocidadXRight(self):
        ...
        print("estoy",self.animacion_actual)
